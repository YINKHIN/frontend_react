...
import { Plus, Search, Edit, Trash2, Package, Download, RefreshCw, Calendar, Eye, FileText } from 'lucide-react';
                ...
                return (
                  <tr key={importItem.id} className="table-row hover:bg-gray-50">
                    ...
                    <td className="table-cell w-16">
                      ...
                      >
                        {isExpanded ? <Calendar className="w-4 h-4 text-gray-600" /> : <Calendar className="w-4 h-4 text-gray-600" />}
                      </button>
                    </td>
