    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden  lg:flex lg:w-1/2 bg-gradient-to-br from-primary-100 to-primary-800 relative overflow-hidden">
        <div className=" absolute min-h-screen flex  justify-center ">
          <img
            className="min-h-screen fixed  m-auto items-center w-full object-cover"
            src={Bg}
            alt="IMS Background"
          />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            <div className="w-64 m-auto fixed top-36 ml-40 bg-white bg-opacity-100 position-relative rounded-full items-center justify-center t-20">
              <img src={Logo} alt="Logo IMS" />
            </div>
            <p className="text-xl fixed text-primary-100 leading-relaxed">
              Create your account and start managing your inventory with <br/> our
              powerful tools. Get access to comprehensive features designed <br/> for
              modern businesses.
            </p>
          </div>
